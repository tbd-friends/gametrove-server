...
{
    public class when_an_image_for_a_different_game_is_cover_art : InMemoryContext<GameTrackerContext>
    {
        ...
        private readonly Guid _otherGameId = Guid.Parse("46406770-B224-43C9-8B40-BBDC98EC11E4");

        public when_an_image_for_a_different_game_is_cover_art()
        {
            Arrange();
        ...
        [Fact]
        public void other_game_image_remains_marked_as_cover_art()
        {
            Context.PlatformGameImages.Single(pgi => pgi.Id == _otherImageId).IsCoverArt.Should().BeTrue();
        }
    }
}