...
{
    public class when_game_exists_for_another_tenant : InMemoryContext<GameTrackerContext>
    {
        ...
        private readonly Guid _otherUserTenantId = new Guid("D26D3EC7-04F1-4284-99AF-676D7FE077B6");

        public when_game_exists_for_another_tenant()
        {
            Arrange();
        ...
        {
            Context.Games.Single(g => g.TitleId == _titleId && g.TenantId == _tenantId);
        }
    }
}