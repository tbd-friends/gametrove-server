...
{
    public class when_null_subtitle_is_provided : InMemoryContext<GameTrackerContext>
    {
        ...
        public when_null_subtitle_is_provided()
        {
            Arrange();
        ...
        public void new_title_details_are_returned()
        {
            ...
            _result.Subtitle.Should().Be(null);
        }
    }
}